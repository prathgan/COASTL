...
def process(logic):
	...
	return process_logic(logic, None, None)

def process_logic(logic, range_start, range_end):
	"""
	...
	if start==0 and end==len(logic)-1:
		return process_logic(logic[1:len(logic)-1], range_start, range_end)
...
def not_node(logic, start, end, range_start, range_end):
	return Node(None, process_logic(logic[start+1:end, range_start, range_end], range_start, range_end), None, 0, "~", "", None, None, "~")

def g_node(logic, start, end, range_start=None, range_end=None):
	firstnum, secondnum, closep = square_parens(logic, 1)
	return Node(None, process_logic(logic[closep+1:], firstnum, secondnum), None, 0, "G", "", None, None, logic[0:closep+1])

def f_node(logic, start, end, range_start=None, range_end=None):
	firstnum, secondnum, closep = square_parens(logic, 1)
	return Node(None, process_logic(logic[closep+1:], firstnum, secondnum), None, 0, "F", "", firstnum, secondnum, logic[0:closep+1])

def con_node(andor_info, range_start, range_end):
	return Node(None, process_logic(andor_info[0], range_start, range_end), process_logic(andor_info[2], range_start, range_end), 0, andor_info[1], "", None, None, andor_info[1])
