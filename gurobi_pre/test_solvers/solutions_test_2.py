...
m.addConstr(2 * b0 <= b1_0 + b1_1, "c1")
m.addConstr(b1_0 + b1_1 <= 1 + b0, "c2")
...
# (x(2)>=0) || (x(2)<=0)
m.addConstr(b1_0 <= b2_0 + b3_0, "c3")
m.addConstr(b2_0 + b3_0 <= 2 * b1_0, "c4")
m.addConstr(b1_0 <= b2_0 + b3_0, "c5")
m.addConstr(b2_0 + b3_0 <= 2 * b1_0, "c6")
